"""campus_connect_31076 URL Configuration
...
admin.site.site_header = "Campus Connect"
admin.site.site_title = "Campus Connect Admin Portal"
admin.site.index_title = "Campus Connect Admin"

# swagger
api_info = openapi.Info(
    title="Campus Connect API",
    default_version="v1",
    description="API documentation for Campus Connect App",
)
